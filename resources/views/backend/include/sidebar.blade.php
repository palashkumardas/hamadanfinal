    ...
    <div class="scroll-sidebar">
        ...
        <div class="user-profile">
            <div class="user-pro-body">
                <div>
                    <!-- <img src="{{asset('backend/assets/images/razekeen.png')}}" alt="user-img" class="img-circle"> -->
                    <img src="{{ asset('frontend_new/assets/img/hamadam_logo.png')}}" alt="user-img" class="img-circle">
