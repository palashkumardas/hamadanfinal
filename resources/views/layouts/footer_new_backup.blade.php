...
<footer id="footer">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 footer-links">
          <h4>Useful Links</h4>
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="{{url('/terms-and-conditions/')}}">Terms of service</a></li>
        ...
        <div class="col-lg-3 col-md-6 footer-links">
          <h4>Our Services</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="{{url('/services/')}}">Quick Money transfer</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="{{url('/services/')}}">Cheap Air Ticket</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="{{url('/services/')}}">Hajj & Umrah Services</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="{{url('/services/')}}">Cargo & Courier</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="{{url('/services/')}}">Consular Services</a></li>
            </ul>
        </div>
        ...
        <div class="col-lg-3 col-md-6 footer-links">
          ...
          <div class="mt-3">
            <div class="row align-self-center">
              ...
              <div class="col-md-8">
                <a href=""><img src="{{ asset('frontend_new/assets/img/logo-white.svg')}}" alt=""></a>
              </div>
            </div>
  ...
  <div class="container py-4 ">
    <div class="copyright">
      &copy; Copyright <strong><span>Hamadan</span></strong>. All Rights Reserved
    </div>
...
<!-- End Footer -->
  ...
  <!--          <h4>Our Services</h4>-->
  <!--          <ul>-->
  <!--            <li><i class="bx bx-chevron-right"></i> <a href="#">Quick Money transfer</a></li>-->
  <!--            <li><i class="bx bx-chevron-right"></i> <a href="#">Cheap Air Ticket</a></li>-->
  <!--            <li><i class="bx bx-chevron-right"></i> <a href="#">Hajj & Umrah Services</a></li>-->
  <!--            <li><i class="bx bx-chevron-right"></i> <a href="#">Cargo & Courier</a></li>-->
  <!--            <li><i class="bx bx-chevron-right"></i> <a href="#">Consular Services</a></li>-->
  <!--          </ul>-->
  <!--        </div>-->
  ...
  <!--    </div>-->
  <!--    <div class="credits">-->
  <!--      Designed by <a href="https://worldwidesvc.com/">Worldwide</a>-->
  <!--    </div>-->
  <!--  </div>-->
  <!--</footer>-->
  <!-- End Footer -->
