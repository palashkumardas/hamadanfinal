...
<head>
  ...
  <!-- =======================================================
  * Template Name: Razekaan - v2.1.0
  * Template URL: https://bootstrapmade.com/Razekaan-bootstrap-business-template/
  ...
  <header id="header" class="header fixed-top" data-scrollto-offset="0">
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <a href="{{ url('/') }}" class="logo d-flex align-items-center scrollto me-auto me-lg-0">
        ...
        <img src="{{ asset('fontend/assets/img/razekeen.png')}}" alt="">
        <!-- <h1>Razekaan<span>.</span></h1> -->
      </a>
      ...
      <a class="btn-getstarted scrollto" href="https://worldwide.razikeen.co.uk">Get Started</a>
